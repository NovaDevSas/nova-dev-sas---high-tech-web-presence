  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 text-center" style={{ zIndex: 3 }}>
        <AnimatedSection>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-extrabold text-brand-light tracking-wider uppercase" dangerouslySetInnerHTML={{ __html: t.title.replace('Deploy.', '<span class="animated-gradient-text">Deploy.</span>').replace('Desplegar.', '<span class="animated-gradient-text">Desplegar.</span>') }}></h1>
        </AnimatedSection>
        <AnimatedSection delay={200}>
          <p className="mt-6 text-lg md:text-xl max-w-3xl mx-auto text-brand-light/80">
            {t.subtitle}
          </p>
        </AnimatedSection>
