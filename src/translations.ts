        ...
        teamMembers: [
            {
                ...
                src: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Implementation was seamless and the results exceeded our expectations. The platform's flexibility is remarkable.",
                name: "Michael Rodriguez",
                designation: "CTO at InnovateSphere",
                src: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "This solution has significantly improved our team's productivity. The intuitive interface makes complex tasks simple.",
                name: "Emily Watson",
                designation: "Operations Director at CloudScale",
                src: "https://images.unsplash.com/photo-1623582854588-d60de57fa33f?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Outstanding support and robust features. It's rare to find a product that delivers on all its promises.",
                name: "James Kim",
                designation: "Engineering Lead at DataPro",
                src: "https://images.unsplash.com/photo-1636041293178-808a6762ab39?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "The scalability and performance have been game-changing for our organization. Highly recommend to any growing business.",
                name: "Lisa Thompson",
                designation: "VP of Technology at FutureNet",
                src: "https://images.unsplash.com/photo-1624561172888-ac93c696e10c?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            }
        ],
        seo: {
...
User Interface (UI) Design, on the other hand, is the micro-level execution of the UX strategy. It's the visual and interactive part of the product—the buttons, the colors, the typography, and the layout. A UI designer focuses on making the interface aesthetically pleasing, visually consistent, and intuitive to interact with. While UX is the skeleton, UI is the skin and clothes. A product can have a beautiful UI but a terrible UX, and vice-versa. True success is achieved when both disciplines work in perfect harmony.`
  ...
  es: {
    ...
    about: {
        ...
        teamMembers: [
            {
                quote: "La atención al detalle y las características innovadoras han transformado por completo nuestro flujo de trabajo. Esto es exactamente lo que buscábamos.",
                name: "Sara Gómez",
                designation: "Gerente de Producto en TechFlow",
                src: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "La implementación fue perfecta y los resultados superaron nuestras expectativas. La flexibilidad de la plataforma es notable.",
                name: "Miguel Rodríguez",
                designation: "CTO en InnovateSphere",
                src: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Esta solución ha mejorado significativamente la productividad de nuestro equipo. La interfaz intuitiva simplifica las tareas complejas.",
                name: "Emily Watson",
                designation: "Directora de Operaciones en CloudScale",
                src: "https://images.unsplash.com/photo-1623582854588-d60de57fa33f?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Soporte excepcional y características robustas. Es raro encontrar un producto que cumpla con todas sus promesas.",
                name: "Carlos Kim",
                designation: "Líder de Ingeniería en DataPro",
                src: "https://images.unsplash.com/photo-1636041293178-808a6762ab39?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "La escalabilidad y el rendimiento han sido un cambio radical para nuestra organización. Lo recomiendo encarecidamente a cualquier negocio en crecimiento.",
                name: "Lisa Thompson",
...
Por otro lado, el Diseño de Interfaz de Usuario (UI) es la ejecución a nivel micro de la estrategia de UX. Es la parte visual e interactiva del producto: los botones, los colores, la tipografía y la disposición. Un diseñador de UI se enfoca en hacer que la interfaz sea estéticamente agradable, visualmente consistente e intuitiva para interactuar. Mientras que la UX es el esqueleto, la UI es la piel y la ropa. Un producto puede tener una UI hermosa pero una UX terrible, y viceversa. El verdadero éxito se logra cuando ambas disciplinas trabajan en perfecta armonía.`
  ...
  ja: {
    ...
    about: {
        ...
        teamMembers: [
            {
                quote: "細部へのこだわりと革新的な機能が、私たちのワークフローを完全に変えました。これこそが私たちが探していたものです。",
                name: "サラ・チェン",
                designation: "TechFlowプロダクトマネージャー",
                src: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "実装はシームレスで、結果は私たちの期待を上回りました。プラットフォームの柔軟性は素晴らしいです。",
                name: "マイケル・ロドリゲス",
                designation: "InnovateSphere CTO",
                src: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "このソリューションは、私たちのチームの生産性を大幅に向上させました。直感的なインターフェースが複雑なタスクを簡素化します。",
                name: "エミリー・ワトソン",
                designation: "CloudScaleオペレーションディレクター",
                src: "https://images.unsplash.com/photo-1623582854588-d60de57fa33f?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "卓越したサポートと堅牢な機能。すべての約束を果たす製品を見つけるのは稀です。",
                name: "キム・ジェームズ",
                designation: "DataProエンジニアリングリード",
                src: "https://images.unsplash.com/photo-1636041293178-808a6762ab39?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "スケーラビリティとパフォーマンスは、私たちの組織にとって画期的なものでした。成長中のビジネスには強くお勧めします。",
                name: "リサ・トンプソン",
                designation: "FutureNet技術担当副社長",
                src: "https://images.unsplash.com/photo-1624561172888-ac93c696e10c?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            }
        ],
        seo: {
...
一方、ユーザーインターフェース（UI）デザインは、UX戦略のミクロレベルの実行です。それは製品の視覚的でインタラクティブな部分、つまりボタン、色、タイポグラフィ、レイアウトです。UIデザイナーは、インターフェースを美的に魅力的にし、視覚的に一貫性があり、直感的に操作できるようにすることに焦点を当てます。UXが骨格であるとすれば、UIは皮膚と衣服です。製品は美しいUIを持ちながらひどいUXを持つことも、その逆もあり得ます。真の成功は、両方の専門分野が完璧な調和で機能するときに達成されます。`
  ...
  ru: {
    ...
    about: {
        ...
        teamMembers: [
            {
                quote: "Внимание к деталям и инновационные функции полностью преобразили наш рабочий процесс. Это именно то, что мы искали.",
                name: "Сара Чен",
                designation: "Менеджер по продукту в TechFlow",
                src: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Внедрение прошло гладко, и результаты превзошли наши ожидания. Гибкость платформы поразительна.",
                name: "Михаил Родригес",
                designation: "Технический директор в InnovateSphere",
                src: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Это решение значительно повысило производительность нашей команды. Интуитивно понятный интерфейс упрощает сложные задачи.",
                name: "Эмили Уотсон",
                designation: "Операционный директор в CloudScale",
                src: "https://images.unsplash.com/photo-1623582854588-d60de57fa33f?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Выдающаяся поддержка и надежные функции. Редко можно найти продукт, который выполняет все свои обещания.",
                name: "Джеймс Ким",
                designation: "Ведущий инженер в DataPro",
                src: "https://images.unsplash.com/photo-1636041293178-808a6762ab39?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            },
            {
                quote: "Масштабируемость и производительность изменили правила игры для нашей организации. Настоятельно рекомендую любому растущему бизнесу.",
                name: "Лиза Томпсон",
                designation: "Вице-президент по технологиям в FutureNet",
                src: "https://images.unsplash.com/photo-1624561172888-ac93c696e10c?q=80&w=800&h=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            }
        ],
        seo: {
